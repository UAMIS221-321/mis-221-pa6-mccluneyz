...
function handleEditClick() {
    makeEditable();
    hideButtons();
    var buttonHtml = "<button class=\"btn-primary btn-lg\" onclick=\"handleEditSave(" + myBook.id + ")\">Save</button>"
    buttonHtml += "<button class=\"btn ntm-warning btn-lg btn-cancle\" onclick=\"handleCancelSave()\">Cancel</button>"
...
function handleNewClick() {
    ...
    buttonHtml += "<button class=\"tn btn-warning btn-lg btn-cancle\" onclick=\"handleCancelSave()\">Cancel</button>"
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
...
function handleRentClick() {
    myBook.numAvlb--
    document.getElementById("bookAvlb") = myBook.numAvlb;
    putBook(myBook.id);
}
...
function populateForm() {
    ...
    document.getElementById("bookAuthor").value = myBook.auhtor;
